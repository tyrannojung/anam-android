package com.anam.wallet.data.datasource.local.crypto
...
class SimpleKeyManager(private val context: Context) {
    ...
    fun generateAndStoreKeyPair(alias: String): Pair<String, String> {
        ...
        encryptedPrefs.edit()
            ...
            .putString("public_key_$alias", publicKeyPem)
            .apply()
    ...
    /**
     * Generate key pair (using default alias)
     */
    fun generateKeyPair(): Pair<String, String> {
        return generateAndStoreKeyPair("default")
    }
    
    /**
     * Get public key PEM (using default alias)
     */
    fun getPublicKeyPem(): String {
        // Check if we have the public key stored
        val publicKeyPem = encryptedPrefs.getString("public_key_default", null)
