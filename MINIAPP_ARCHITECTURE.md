# AnamWallet 슈퍼앱 미니앱 아키텍처

## 1. 개요

AnamWallet은 블록체인 지갑 기능을 기반으로 한 슈퍼앱으로, W3C MiniApp 표준을 따르는 미니앱 생태계를 지원합니다.
...
- **AnamWallet**: 각 모듈이 독립된 프로세스에서 실행되며 개별 키 관리로 위험 분산
...
- **AnamWallet**: 모바일 네이티브 앱 + 브라우저 확장으로 다양한 환경에서 사용 가능
